...
const filePath = path.join(__dirname, 'src', 'components', 'ProcessSection.tsx');
...
content = content.replace('className="bg-white h-screen flex flex-col justify-center overflow-hidden relative z-10 process-section-wrapper"', 'className="bg-white md:h-screen flex flex-col md:justify-center overflow-hidden relative z-10 process-section-wrapper py-24 md:py-0"');
...
console.log("Updated ProcessSection.tsx successfully.");
