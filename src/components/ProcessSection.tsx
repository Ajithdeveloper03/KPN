  ...
  return (
    <div>
      <section
        id="process"
        ref={sectionRef}
        className="bg-[#f3f4f6] min-h-[auto] md:min-h-[700px] md:h-screen flex flex-col md:justify-center overflow-hidden relative z-10 process-section-wrapper py-4 md:py-6"
      >
        {/* Header */}
