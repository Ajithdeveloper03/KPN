...
export default function CTASection({ setIsModalOpen }: { setIsModalOpen: (val: boolean) => void }) {
  return (
    <section id="contact" className="bg-white py-20">
      <div className="max-w-[1400px] w-full mx-auto px-6">
        <div className="bg-[#ea0000] rounded-2xl relative overflow-hidden flex flex-col md:flex-row items-center min-h-[420px] shadow-2xl">
          ...
          <div className="relative z-10 p-10 md:p-16 md:w-[60%] flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="bg-white text-[#ea0000] font-bold text-sm px-8 py-3.5 rounded transition-all duration-300 hover:bg-gray-100"
              >
                START YOUR JOURNEY
              </button>
              <button
          ...
          {/* Right Image (Builder/Hard Hat) */}
          <div className="relative z-10 w-full md:w-[40%] h-[300px] md:h-[420px] self-end hidden md:block">
            <Image
