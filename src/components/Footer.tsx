    ...
    <>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3 text-slate-400 font-medium">
                ...
                <div className="text-slate-400">
                  <a href="tel:+919788770786" className="no-underline hover:text-[#00a3e0] transition-colors">+91 9788770786</a>
                  {", "}
                  <a href="tel:04312660786" className="no-underline hover:text-[#00a3e0] transition-colors">+91 0431-2660786</a>
                </div>
              </div>
              <div className="flex items-center gap-3 text-slate-400 font-medium">
              ...
              <div className="flex items-center gap-4 mt-2">
                ...
                <a href="https://www.instagram.com/kpnroofingshed" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-[#E4405F] transition-colors" aria-label="Instagram">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                </a>
                <a href="https://www.youtube.com/@kpnroofingshedindia" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-[#FF0000] transition-colors" aria-label="YouTube">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-[200] bg-white border-t border-slate-200 shadow-lg md:hidden">
        <div className="grid grid-cols-2">
          <a href="tel:+919788770786" className="flex items-center justify-center gap-2 py-4 bg-[#004b87] text-white font-bold text-sm no-underline">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
            Call Now
          </a>
          <a href="https://wa.me/919788770786?text=I%27m%20interested%20in%20a%20roofing%20shed%20project" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 py-4 bg-[#25d366] text-white font-bold text-sm no-underline">
