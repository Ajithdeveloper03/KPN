...
import { 
  ...
  Truck, CheckCircle2, Compass, Layers, Sparkles, Wind
} from 'lucide-react';
...
export const metadata: Metadata = {
  alternates: {
    canonical: "https://kpnroofingsheds.com/shed-contractors-rajasthan/",
  },
  title: 'Shed Contractors in Rajasthan | Industrial & Farm Roofing Sheds — KPN',
  description: 'KPN Roofing Shed builds industrial, agricultural, home, and sports sheds across Rajasthan. 13+ years, 1000+ projects, 10-year guarantee. Free quote.',
  keywords: 'shed contractors Rajasthan, roofing shed contractors Jaipur, industrial shed builders Bhiwadi, shed construction Jodhpur',
};
...
export default function RajasthanLocationPage() {
  return (
    <div className="min-h-screen bg-[#f8f9fa] text-[#111] selection:bg-[#ffcc00] selection:text-[#111] flex flex-col font-sans">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "@id": "https://kpnroofingsheds.com/shed-contractors-rajasthan/#webpage",
            "url": "https://kpnroofingsheds.com/shed-contractors-rajasthan/",
            "name": "Shed Contractors in Rajasthan | Industrial & Farm Roofing Sheds — KPN",
            "description": "KPN Roofing Shed builds industrial, agricultural, home, and sports sheds across Rajasthan. 13+ years, 1000+ projects, 10-year guarantee. Free quote.",
            "isPartOf": {
      ...
      <PageHero
        title="Shed Contractors in Rajasthan"
        bgImage="/images/factory-2.webp"
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "Rajasthan", href: "/shed-contractors-rajasthan/" }
        ]}
      />
      ...
      <main className="flex-grow">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-10 lg:gap-12">
            <div className="lg:col-span-7 flex flex-col items-start text-left space-y-5">
              <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-slate-300 bg-white text-sm font-bold text-[#ee0000] tracking-wide uppercase shadow-sm">
                <MapPin size={16} /> Industrial, Farm, Home &amp; Sports Roofing
              </span>
              <h2 className="text-3xl md:text-5xl lg:text-5xl font-extrabold text-[#111] leading-[1.15] tracking-tight">
                Rajasthan Shed Builders — <span className="font-serif font-medium text-[#062088] italic">Industrial, Farm, Home &amp; Sports Roofing</span>
              </h2>
              <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-normal">
                Rajasthan, India&apos;s largest state by area, has a strong agricultural and livestock sector, along with major industrial areas around Jaipur, Bhiwadi, Neemrana, and other cities.
              </p>
              <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-normal">
                KPN Roofing Shed has been building exactly that for over 13 years — with 1000+ completed projects across India. Whether it&apos;s a dairy or goat shed on a farm property, a warehouse near an industrial zone, a terrace roof in a residential area, or a badminton court or cricket turf for a sports facility, KPN brings in-house engineering, Apollo-brand steel, transparent pricing, and its own installation crew with no subcontracting to Rajasthan projects.
              </p>
            ...
            <div className="lg:col-span-5">
              <div className="bg-white p-8 lg:p-10 rounded-[2.5rem] shadow-xl border border-slate-100 relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <h3 className="text-2xl font-bold text-[#111]">Rajasthan Project Snapshot</h3>
                  <p className="text-slate-600 leading-relaxed">
                    Custom-designed sheds for farms, factories, warehouses, large properties, and sports facilities across Rajasthan.
                  </p>
          ...
          <div className="max-w-[1400px] mx-auto px-6 relative z-10">
            <div className="text-center mb-8 max-w-3xl mx-auto">
              <span className="px-5 py-2 rounded-full border border-slate-300 text-xs font-bold text-[#ee0000] tracking-widest uppercase mb-4 inline-block bg-[#f8f9fa] shadow-sm">
                Shed Construction Services in Rajasthan
              </span>
              ...
              <p className="text-lg md:text-xl text-slate-600 font-normal leading-relaxed">
                Rajasthan&apos;s farm belt — including regions around Jodhpur and Bikaner — has a strong agricultural and livestock sector, creating steady demand for practical farm and animal sheds. Each project is custom-designed — never mass-produced.
              </p>
            </div>
          ...
          <div className="max-w-[1400px] mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            <div className="space-y-3">
              ...
              <h2 className="text-xl md:text-3xl font-bold tracking-tight text-white leading-tight">
                ...
                <span className="text-[#ffcc00]">Jaipur, Bhiwadi, Neemrana &amp; Rajasthan</span>
              </h2>
              <p className="text-lg md:text-xl text-slate-300 font-normal leading-relaxed max-w-xl">
                Rajasthan&apos;s industrial belt — including Jaipur, Bhiwadi, Neemrana, and Pali — needs robust, functional covered spaces for manufacturing, textiles, and storage. KPN delivers project-specific shed solutions based on site requirements.
              </p>
              ...
              <div className="p-4 bg-white/5 border border-white/10 rounded-2xl max-w-xl">
                <div className="text-slate-300 text-sm md:text-base leading-relaxed">
                  <span className="font-bold text-white">Ideal for:</span> Manufacturing units, textile factories, warehouses, godowns, workshops, logistics hubs.
                </div>
          ...
          <div className="max-w-[1400px] mx-auto px-6 space-y-6">
            ...
            <div className="bg-white rounded-[2.5rem] p-2 md:p-3 shadow-xl border border-slate-200 grid grid-cols-1 lg:grid-cols-2 overflow-hidden group">
              <div className="bg-[#062088] rounded-[2rem] p-8 lg:p-12 text-white flex flex-col justify-center relative overflow-hidden">
                ...
                <h3 className="text-3xl lg:text-4xl font-bold mb-4 relative z-10">Commercial &amp; Large Residential Roofing Sheds</h3>
                <p className="text-blue-200 text-lg leading-relaxed relative z-10 mb-4">
                  Rajasthan&apos;s climate — intense summer heat, low humidity, and occasional dust storms — makes properly planned, ventilated roofing a practical necessity for large properties. This category covers bigger residential and commercial roofing needs, such as villa communities in Jodhpur or farmhouse complexes, rather than a single small terrace or car port.
                </p>
                <div className="text-blue-100 text-sm font-semibold relative z-10 mb-4">
                  <span className="text-white font-bold">Ideal for:</span> Large farmhouses, villa communities, gated communities, and multi-car commercial parking (minimum 2,400 sq.ft for outstation Rajasthan projects).
                </div>
              ...
              <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                ...
                <div className="space-y-5 order-1 lg:order-2">
                  ...
                  <p className="text-slate-100 text-lg leading-relaxed max-w-lg">
                    Schools, colleges, sports academies, and residential communities across Rajasthan are investing in covered sports facilities. KPN builds them right.
                  </p>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 flex items-start gap-4 shadow-sm">
              ...
              <p className="text-slate-800 text-base md:text-lg font-medium leading-relaxed">
                <span className="font-bold text-[#111]">Note:</span> KPN&apos;s outstation projects, including Rajasthan, start from a minimum area of <span className="font-bold text-[#062088]">2,400 sq.ft</span>. A small single-home terrace or car port below this size is best combined with a larger property need, or discussed directly with our team.
              </p>
            </div>
          </div>
        </section>

        {/* ---------------- 5. Rajasthan Project Snapshot Table ---------------- */}
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-[#111]">
                Rajasthan Project <span className="font-serif italic text-[#062088]">Snapshot</span>
              </h2>
            </div>
                  ...
                  <tbody className="divide-y divide-slate-100 font-medium text-slate-700">
                    <tr className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="py-4 px-6 text-slate-800">
                        Jaipur, Jodhpur, Udaipur, Kota, Bikaner, Ajmer, and across Rajasthan
                      </td>
                    </tr>
        ...
        {/* ---------------- 6. Why Rajasthan Clients Choose KPN ---------------- */}
          ...
          <div className="max-w-[1400px] mx-auto px-6">
            <div className="text-center mb-8 max-w-3xl mx-auto">
              ...
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-[#111]">
                Why Rajasthan Clients <span className="font-serif italic text-[#062088]">Choose KPN</span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { 
                  ...
                  desc: "You work directly with KPN. No brokers, no dealers, no hidden commissions. Clear communication from start to finish.",
                ...
                { 
                  title: "Built for Rajasthan's Extreme Climate", 
                  desc: "KPN structures use Apollo-brand steel with roofing and structural planning suited to Rajasthan's climate, along with appropriate roof slopes, drainage, and ventilation planning based on project requirements.",
                  icon: <Wind size={28} />,
                  bg: "bg-blue-50",
                  color: "text-[#062088]",
                ...
                { 
                  ...
                  desc: "Every project is designed from scratch — based on your site, soil conditions, wind load, and usage. No cookie-cutter designs.",
                ...
                { 
                  ...
                  desc: "Centralized, automated fabrication at our Tamil Nadu facility supports consistent structural precision and finish before materials are transported and professionally installed at your Rajasthan site.",
                ...
                { 
                  ...
                  desc: "We use Apollo steel consistently across all projects. No material compromise, no quality variance.",
                  icon: <Box size={28} />,
                  bg: "bg-red-50",
                  color: "text-[#ee0000]",
                  hoverBorder: "hover:border-[#ee0000]"
                ...
                { 
                  ...
                  desc: "KPN brings experience from projects across India, with the same focus on structured planning, quality materials, transparent pricing, and professional installation for Rajasthan projects.",
                  icon: <Truck size={28} />,
                  bg: "bg-amber-50",
                  color: "text-amber-600",
                  hoverBorder: "hover:border-[#ffcc00]"
        ...
        {/* ---------------- 7. How a Rajasthan Project Works ---------------- */}
        <section className="bg-[#f8f9fa] py-8 lg:py-12 border-b border-slate-200">
          <div className="max-w-[1400px] mx-auto px-6">
            <div className="text-center mb-8 max-w-3xl mx-auto">
              <span className="px-5 py-2 rounded-full border border-slate-300 text-xs font-bold text-[#062088] tracking-widest uppercase mb-4 inline-block bg-white shadow-sm">
              ...
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-[#111] mb-4">
                How a Rajasthan <span className="font-serif italic text-[#062088]">Project Works</span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 gap-y-12 pt-6">
              {[
                { 
                  title: "Enquiry", 
                  desc: "Call, WhatsApp, or fill the form — share your shed type, approximate size, and Rajasthan location. Outstation projects start from a 2,400 sq.ft minimum area." 
                },
                { 
                  title: "Site Assessment", 
                  desc: "For distant sites, we begin with photos/video call assessment; an in-person visit is scheduled where the project scope justifies it." 
                },
                { 
                  title: "Design & Engineering", 
                  desc: "Our team plans dimensions, materials, roof slope, and structural load — factoring in Rajasthan's soil conditions and wind exposure from open terrain." 
                },
                { 
                  title: "Quotation", 
                  desc: "You get a detailed, itemized quote that includes fabrication and outstation transport to your Rajasthan site — no generic rates." 
                },
                { 
                  title: "Fabrication & Dispatch", 
                  desc: "Materials are fabricated at our Tamil Nadu facility and dispatched for cross-state delivery, coordinated around road access to your site." 
                },
                { 
                  title: "Installation", 
                  desc: "Our crew travels to site and completes the build, scheduled around site readiness and material arrival." 
                }
              ].map((step, i) => (
          ...
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
              {[
                ...
                { label: "Available area", detail: "Plot or terrace dimensions (note: outstation projects like Rajasthan start from a 2,400 sq.ft minimum)" },
                { label: "Soil type", detail: "Rajasthan's sandy and loose soil in many areas affects foundation planning" },
                { label: "Wind exposure", detail: "Open desert plots face stronger wind loads, which affects anchoring and structural bracing" },
                { label: "Water access on site", detail: "Relevant for construction logistics" },
                { label: "Site access", detail: "Road condition and access for material transport, since materials are fabricated and shipped from our Tamil Nadu facility" },
            ...
            <div className="bg-[#f0f7ff] border border-blue-200 rounded-2xl p-6 text-center">
              <p className="text-slate-700 font-bold text-lg">
                Share as much as you can — the more we know about your site&apos;s soil and access, the sharper the quote and structural plan.
              </p>
            </div>
          </div>
        </section>

        {/* ---------------- 9. Coverage Area in Rajasthan ---------------- */}
        <section className="bg-[#f8f9fa] py-8 lg:py-10 border-b border-slate-200">
          <div className="max-w-[1200px] mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-[#111] mb-3">
              KPN Shed Construction Coverage in <span className="font-serif italic text-[#062088]">Rajasthan</span>
            </h2>
            <p className="text-lg text-slate-500 font-medium max-w-3xl mx-auto mb-6">
              We undertake shed construction across major industrial clusters, agricultural belts, and cities across Rajasthan.
            </p>

            <div className="flex flex-wrap justify-center gap-3">
              {[
                'Jaipur', 'Jodhpur', 'Udaipur', 'Kota', 'Bikaner', 'Ajmer', 
                'Bhiwadi', 'Neemrana', 'Pali', 'Alwar', 'Sikar', 'Bharatpur', 
                'Bhilwara', 'Sri Ganganagar', 'Barmer', 'Chittorgarh'
              ].map((city, i) => (
        ...
        {/* ---------------- 10. Frequently Asked Questions — Rajasthan ---------------- */}
        <section className="bg-white py-8 lg:py-12 border-b border-slate-200">
          <div className="max-w-[1000px] mx-auto px-6">
            <div className="text-center mb-8">
              <span className="text-slate-500 font-medium tracking-wide uppercase text-xs block mb-2">Rajasthan Guide</span>
            ...
            <div className="space-y-4">
              {[
                { 
                  q: "1. Does KPN build sheds in all parts of Rajasthan?", 
                  a: "Yes. KPN undertakes eligible shed projects across Rajasthan, including locations such as Jaipur, Jodhpur, Udaipur, Kota, Bikaner, and Ajmer, subject to the minimum project area, project scope, site conditions, and logistics." 
                },
                { 
                  q: "2. What types of sheds do you build in Rajasthan?", 
                ...
                { 
                  q: "3. Can KPN sheds handle Rajasthan's extreme climate?", 
                  a: "Yes. We use Apollo-brand steel with roofing and structural planning suited to Rajasthan's climate, proper roof slopes, gutters, and ventilation systems — designed to withstand intense summer heat, low rainfall, and dust storms." 
                },
                { 
                  q: "4. How long does a typical shed project take in Rajasthan?", 
                  a: "For Rajasthan projects, the timeline includes precision fabrication at our Tamil Nadu facility, cross-state transport, and on-site crew installation. Timelines vary depending on shed size and road connectivity, and we confirm a project-specific delivery schedule during the quotation stage." 
                },
                { 
                  q: "5. Is there a warranty on Rajasthan projects?", 
                  a: "Yes. KPN provides a 10-year guarantee with free repair support for covered damage (terms apply)." 
                },
                { 
                  q: "6. Do you serve areas outside Rajasthan?", 
                  a: "Yes. Beyond Rajasthan, KPN undertakes projects across India, including neighbouring states, subject to project scope, the minimum area requirement, and site logistics." 
                },
                { 
                  q: "7. How much does a shed cost in Rajasthan?", 
                  a: "The cost of a shed in Rajasthan depends on the shed type, size, structural requirements, roofing material, site conditions, and installation requirements. KPN provides project-specific quotations after reviewing the required dimensions and site details." 
                },
                { 
                  q: "8. What makes KPN different for a Rajasthan project specifically?", 
                  a: "Beyond pan-India experience and in-house engineering, KPN plans every Rajasthan project around the region's soil conditions and climate — including wind load from open terrain and extreme summer heat — and coordinates fabrication-to-installation logistics for outstation delivery, all with transparent, itemized pricing and no subcontracting." 
                }
              ].map((faq, i) => (
        ...
        {/* ---------------- 11. Planning a Shed in Rajasthan? (Bottom CTA Banner) ---------------- */}
        <section className="bg-[#ffcc00] py-8 lg:py-12 text-center border-t border-yellow-400">
          <div className="max-w-5xl mx-auto px-6">
            <h2 className="text-3xl md:text-5xl font-extrabold text-[#111] mb-4 tracking-tight">
              Planning a Shed in Rajasthan?
            </h2>
            <p className="text-lg md:text-xl text-justify text-slate-900 font-medium mb-3 max-w-3xl mx-auto leading-relaxed">
              From farm sheds engineered for desert soil and heat to factory roofs, warehouses, terrace covers, car parking, and sports turf — KPN plans every Rajasthan project around your site&apos;s soil, climate, and logistics needs, not a generic template.
            </p>
            <p className="text-lg md:text-xl text-[#062088] text-start font-bold mb-6 max-w-3xl mx-auto">
              Get a free site assessment and a transparent, itemized quote — outstation projects start from a 2,400 sq.ft minimum.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
              ...
              <a 
                href="https://wa.me/919788770786?text=Hi%20KPN%20Roofing%20Shed%2C%20I%20am%20planning%20a%20shed%20project%20in%20Rajasthan" 
                target="_blank" 
