          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="w-full lg:w-[68%]">
              ...
              <div className="flex items-center gap-3 mb-10 pb-10 border-b border-slate-200">
                ...
                <button className="w-11 h-11 rounded-full bg-[#f8f9fc] border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] transition-all shrink-0">
                ...
                <button className="w-11 h-11 rounded-full bg-[#f8f9fc] border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-[#1DA1F2] hover:text-white hover:border-[#1DA1F2] transition-all shrink-0">
                ...
                <button className="w-11 h-11 rounded-full bg-[#f8f9fc] border border-slate-200 flex items-center justify-center text-slate-600 hover:bg-[#0A66C2] hover:text-white hover:border-[#0A66C2] transition-all shrink-0">
