...
export const metadata: Metadata = {
  alternates: {
    canonical: "src/app/services/sports-turf-sheds/cricket-turf-shed/page.tsx",
  },
    ...
    <div className="min-h-screen bg-[#faf9f6] text-[#2d3436] font-sans selection:bg-[#d35400] selection:text-white">
      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image 
            src="/images/services/cricket-image-2.webp" 
      ...
      <main>
        ...
        <section className="py-6 lg:py-8 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 relative h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl">
              <Image src="/images/services/cricket-image-1.webp" alt="cricket turf shed India — KPN" fill sizes="100vw" className="object-cover" />
        ...
        <section className="py-6 lg:py-8 px-6 max-w-7xl mx-auto border-b border-gray-200">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 relative h-[400px] rounded-[3rem] overflow-hidden shadow-2xl">
              <Image src="/images/services/cricket-image-2.webp" alt="cricket turf shed — KPN" fill sizes="100vw" className="object-cover" />
        ...
        <section className="py-6 lg:py-8 px-6 max-w-7xl mx-auto border-b border-gray-200">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 relative h-[400px] rounded-[3rem] overflow-hidden shadow-2xl">
              <Image src="/images/services/cricket-image-2.webp" alt="cricket turf roofing shed — KPN Roofing Shed" fill sizes="100vw" className="object-cover" />
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-4 relative">
              ...
              <div className="w-full lg:w-1/3 relative h-[600px] lg:h-[800px] rounded-[3rem] overflow-hidden shadow-2xl z-0">
                <Image src="/images/services/cricket-banner-image.webp" alt="Why KPN" fill sizes="100vw" className="object-cover" />
        ...
        <section className="py-6 lg:py-8 text-center text-white relative overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image src="/images/services/cricket-banner-image.webp" alt="cricket turf shed — KPN" fill sizes="100vw" className="object-cover" />
          </div>
