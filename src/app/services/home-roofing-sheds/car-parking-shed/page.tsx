    ...
    <div className="min-h-screen bg-[#faf9f6] text-[#2d3436] font-sans selection:bg-[#d35400] selection:text-white">
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              <h2 className="text-3xl md:text-4xl font-bold text-[#2d3436] mb-8 leading-tight">
                Protect your vehicles with <span className="font-serif italic text-[#e67e22]">KPN Roofing</span>
              </h2>
            ...
            <div className="lg:w-1/2 relative h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl">
              <Image src="/kpnroofingshed/images/image2.jpeg" alt="car parking shed India — KPN" fill className="object-cover" />
        ...
        <section className="py-12 lg:py-20 overflow-hidden bg-[#fffdfa]">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col lg:flex-row gap-16 mb-24">
              <div className="lg:w-1/2">
                <h2 className="text-4xl md:text-5xl font-bold text-[#2d3436] mb-8">Single-Bay vs <span className="font-serif italic text-[#e67e22]">Multi-Bay Sheds</span></h2>
              ...
              <div className="lg:w-1/2 relative">
                 ...
                 <div className="relative h-full min-h-[300px] rounded-3xl overflow-hidden shadow-xl">
                   <Image src="/kpnroofingshed/images/image1.jpeg" alt="multi-bay car parking shed — KPN Roofing Shed" fill className="object-cover" />
                 </div>
              </div>
            </div>
          </div>
        ...
        {/* ---------------- 4. Common Uses ---------------- */}
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-[#2d3436]">Common Uses of <span className="font-serif italic text-[#3498db]">Parking Sheds</span></h2>
        ...
        <section className="py-12 lg:py-20 px-6 max-w-7xl mx-auto border-b border-gray-200">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 relative h-[400px] rounded-[3rem] overflow-hidden shadow-2xl">
              <Image src="/kpnroofingshed/images/image3.jpeg" alt="car parking shed contractors India — KPN" fill className="object-cover" />
        ...
        <section className="py-12 lg:py-20 px-6 max-w-7xl mx-auto border-b border-gray-200">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-[#2d3436] mb-8">How Long Does a <br/><span className="font-serif italic text-gray-500">Parking Shed Take?</span></h2>
              <p className="text-lg text-gray-600 font-medium leading-relaxed mb-8">
            ...
            <div className="w-full lg:w-1/2 relative h-[400px] rounded-[3rem] overflow-hidden shadow-2xl">
              <Image src="/kpnroofingshed/images/image7.jpeg" alt="car parking shed contractors India — KPN" fill className="object-cover" />
        ...
        <section className="py-16 lg:py-24 text-center text-white relative overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image src="/kpnroofingshed/images/hero-bg.png" alt="car parking shed contractors India — KPN" fill className="object-cover" />
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6 relative z-20">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold mb-6 tracking-tight leading-tight">
              Planning a <span className="font-serif italic font-medium text-[#f39c12]">Car Parking Shed?</span>
            </h2>
