    ...
    <div className="min-h-screen bg-[#f8f9fa] text-[#111] selection:bg-[#ffcc00] selection:text-[#111] flex flex-col font-sans">
      ...
      <PageHero  
        title="Home Roofing Sheds" 
         bgImage="/images/services/home-roofing-shed-banner-image.webp" breadcrumbs={[
          { label: "Home", href: "/" },
      ...
      <main className="flex-grow">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-start text-left space-y-8">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-5xl font-semibold text-[#111] leading-[1.1] tracking-tight">
                ...
                <span className="font-serif font-medium text-[#062088] italic">Terrace & Car Parking Sheds</span>
              </h2>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center gap-2 md:gap-3 mt-16 lg:mt-0">
              ...
              <div className="relative w-1/3 h-[180px] sm:h-[220px] md:h-[350px] rounded-2xl md:rounded-3xl overflow-hidden shadow-lg transform translate-y-4">
                <Image src="/images/services/home-roofing-shed-la-3-section-1-image.webp" alt="Terrace roofing sheds India" fill sizes="100vw" className="object-cover" priority />
              </div>
              ...
              <div className="relative w-1/3 h-[240px] sm:h-[300px] md:h-[480px] rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl z-10 border-2 md:border-4 border-white">
                <Image src="/images/services/home-roofing-shed-banner-image.webp" alt="Home roofing shed construction" fill sizes="100vw" className="object-cover" priority />
              </div>
              
              {/* Image 3: Medium Height */}
              <div className="relative w-1/3 h-[180px] sm:h-[220px] md:h-[350px] rounded-2xl md:rounded-3xl overflow-hidden shadow-lg transform translate-y-4">
                <Image src="/images/services/home-roofing-shed-la-2-section-1-image.webp" alt="Car parking shed contractors India" fill sizes="100vw" className="object-cover" priority />
              </div>
        ...
        <section className="bg-[#f0f7ff] py-10 lg:py-12 relative overflow-hidden border-y border-blue-100">
          <div className="max-w-[1400px] mx-auto px-6 relative z-10">
            <div className="mb-12">
              ...
              <h2 className="text-3xl md:text-5xl font-semibold tracking-tight">Home Roofing Sheds <br/><span className="font-serif font-medium text-[#00a3e0] italic">at a Glance</span></h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              ...
              <div className="bg-[#222d58] p-10 rounded-[2rem] shadow-lg">
                ...
                <ul className="space-y-4 text-blue-100 font-medium leading-relaxed">
                  <li className="flex items-start gap-3"><Check size={20} className="text-[#ffcc00] mt-1 shrink-0" /> <span><strong className="text-white">Warranty:</strong> 10-year guarantee on every shed</span></li>
                  <li className="flex items-start gap-3"><Check size={20} className="text-[#ffcc00] mt-1 shrink-0" /> <span><strong className="text-white">Repair support:</strong> free repair support for covered damage</span></li>
                </ul>
              </div>
              ...
              <div className="bg-[#6f1c1c] p-10 rounded-[2rem] shadow-lg">
                ...
                <ul className="space-y-4 text-red-100 font-medium leading-relaxed">
                  <li className="flex items-start gap-3"><Check size={20} className="text-white mt-1 shrink-0" /> <span><strong className="text-white">Advance:</strong> 50% advance to start</span></li>
              ...
              <div className="bg-[#daaf01] p-10 rounded-[2rem] shadow-lg">
                ...
                <ul className="space-y-4 text-slate-800 font-medium leading-relaxed">
                  <li className="flex items-start gap-3"><Check size={20} className="text-[#ee0000] mt-1 shrink-0" /> <span><strong className="text-[#111]">Coverage:</strong> Pan-India home roofing shed projects</span></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="mb-12 flex flex-col md:flex-row justify-between items-end gap-10">
              <div>
                ...
                <h2 className="text-3xl md:text-5xl font-semibold tracking-tight mb-6">
                  What We <br/><span className="font-serif font-medium text-[#ffcc00] italic">Build</span>
                </h2>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="bg-white hover:bg-[#ffcc00] transition-colors duration-500 rounded-[2rem] p-6 pb-12 border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.03)] group relative overflow-hidden">
                <div className="relative w-full h-[320px] rounded-[1.5rem] overflow-hidden mb-10">
                  <Image src="/images/services/terrace-shed-banner-image.webp" alt="Terrace Roofing Sheds" fill sizes="100vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
                </div>
              ...
              <div className="bg-[#fafafa] hover:bg-[#ffcc00] transition-colors duration-500 rounded-[2rem] p-6 pb-12 border border-slate-200 shadow-sm group relative overflow-hidden flex flex-col-reverse md:flex-col">
                ...
                <div className="relative w-full h-[320px] rounded-[1.5rem] overflow-hidden">
                  <Image src="/images/services/car-parking-banner-image.webp" alt="Car Parking Sheds" fill sizes="100vw" className="object-cover group-hover:scale-105 transition-transform duration-700" />
                </div>
          ...
          <div className="max-w-[1400px] mx-auto px-6 relative z-10">
            <div className="text-center mb-16 max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl md:text-5xl font-semibold text-[#111] leading-tight tracking-tight">
                How to Choose the <span className="font-serif font-medium text-[#062088] italic">Right Home Roofing Shed</span>
              </h2>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10">
              ...
              <div className="w-full lg:w-7/12 relative mt-16 lg:mt-0 mb-12 md:mb-0">
                ...
                <div className="relative w-full aspect-[4/3] md:aspect-[16/10] rounded-[2rem] overflow-hidden shadow-2xl border border-slate-100">
                  <Image src="/images/services/home-roofing-shed-la-1-section-la-2-image.webp" alt="KPN Home Roofing" fill sizes="100vw" className="object-cover" />
                </div>
          ...
          <div className="max-w-[1300px] mx-auto px-6">
            <div className="text-center mb-16">
               <h2 className="text-3xl md:text-5xl font-semibold tracking-tight text-[#111]">
                 What Our Home Roofing <span className="font-serif font-medium text-[#00a3e0] italic">Clients Say</span>
               </h2>
            </div>
          ...
          <div className="max-w-[1300px] mx-auto px-6 flex flex-col lg:flex-row gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-5/12 flex flex-col">
              ...
              <div className="relative w-full h-[300px] md:h-[400px] rounded-[2rem] overflow-hidden shadow-lg mt-auto">
                <Image src="/images/services/home-roofing-shed-faq.webp" alt="FAQ Home Roofing Sheds" fill sizes="100vw" className="object-cover hover:scale-105 transition-transform duration-700" />
              </div>
            </div>
        ...
        <section className="py-12 lg:py-12 text-center text-white relative overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image src="/images/services/home-roofing-shed-la-2-section-1-image.webp" alt="Home Roofing Sheds CTA" fill sizes="100vw" className="object-cover" />
          </div>
          ...
          <div className="max-w-4xl mx-auto px-6 relative z-20">
            <h2 className="text-4xl md:text-5xl font-semibold mb-4 tracking-tight leading-tight">
              Planning a terrace or <span className="font-serif font-medium text-[#ffcc00] italic">car parking shed?</span>
            </h2>
