          ...
          <div className="max-w-[1400px] mx-auto px-6 flex flex-col gap-16">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10">
              ...
              <div className="w-full lg:w-7/12 relative mt-16 lg:mt-0 mb-12 md:mb-0">
                ...
                <div className="absolute -bottom-16 left-4 right-4 md:right-auto md:-bottom-10 md:-left-12 lg:-left-20 bg-[#ffcc00] rounded-3xl p-6 md:p-10 shadow-2xl border border-[#ffcc00]/50 z-20 md:w-[480px]">
